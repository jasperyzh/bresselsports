...
<footer class="bg-zinc-950 border-t border-zinc-900 py-20">
    ...
    <div class="container-custom">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div>
                ...
                <p class="text-zinc-500 text-sm leading-relaxed max-w-xs mb-6">
                    The world's leading high-performance padel academy. Redefining kinetic precision for the professional era.
                </p>
                <!-- Social Links -->
                <div class="flex items-center gap-4">
                    <a href="#" aria-label="Instagram" class="text-zinc-500 hover:text-[var(--color-bressel-red)] transition-colors">
                    ...
                    <a href="#" aria-label="Facebook" class="text-zinc-500 hover:text-[var(--color-bressel-red)] transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="#" aria-label="YouTube" class="text-zinc-500 hover:text-[var(--color-bressel-red)] transition-colors">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?= esc_url(home_url('/academy/')) ?>" class="block text-zinc-500 hover:text-white text-sm py-1 transition-colors">Coaches</a></li>
                    <li><a href="<?= esc_url(home_url('/contact/')) ?>" class="block text-zinc-500 hover:text-white text-sm py-1 transition-colors">Programs</a></li>
                    <li><a href="#centers" class="block text-zinc-500 hover:text-white text-sm py-1 transition-colors">Regional Centers</a></li>
                    <li><a href="#" class="block text-zinc-500 hover:text-white text-sm py-1 transition-colors">Careers</a></li>
                </ul>
            </div>

            <!-- Col 3: COMMUNITY -->
            <div>
                <h4 class="uppercase tracking-widest text-xs text-zinc-400 mb-6">COMMUNITY</h4>
                <ul class="space-y-2">
                    <li><a href="<?= esc_url(home_url('/community/')) ?>" class="block text-zinc-500 hover:text-white text-sm py-1 transition-colors">Events</a></li>
                    <li><a href="#" class="block text-zinc-500 hover:text-white text-sm py-1 transition-colors">Tournaments</a></li>
                    <li><a href="<?= esc_url(home_url('/shop/')) ?>" class="block text-zinc-500 hover:text-white text-sm py-1 transition-colors">BRESSEL PRO</a></li>
    ...
    <div class="container-custom mt-16 pt-6 border-t border-zinc-900">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-zinc-600 text-xs text-center md:text-left">
                &copy; <?= date('Y') ?> BRESSEL™. All rights reserved. (0123456 / MA0123456-U)
            </p>
            <div class="flex items-center gap-6 text-xs">
                <a href="#" class="text-zinc-600 hover:text-white transition-colors">Privacy Policy</a>
                <a href="#" class="text-zinc-600 hover:text-white transition-colors">Terms of Service</a>
            </div>
        </div>
    </div>
